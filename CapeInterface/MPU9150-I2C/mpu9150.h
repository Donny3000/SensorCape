...
// Define the MPU-9150's Registers
...
{
    /*!
     * Class: MPU_9150 - Class for interfacing the the InvenSense MPU-9150
     * 9-Axis Inertial Measurement Unit via the I2C interface
     *
     ...
     *
     * \param bus The I2C bus number the InvenSense IMU is on
     * \param address The address of the InvenSense IMU
     */
    class MPU9150
    {
        public:
            ...
            //! \{
            MPU9150(const __u8 bus, const __u16 address = MPU9150_I2C_ADDRESS);
            virtual ~MPU9150();
            //! \}
            ...
            //! Methods for obtaining the accelerometer data
            //! \{
            ...
            //! Methods for obtaining the gyroscope data
            //! \{
            __u16 GetGyroscopeX();
            __u16 GetGyroscopeY();
            __u16 GetGyroscopeZ();
            ...
            //! Methods for obtaining the magnetometer data
            //! \{
            __u16 GetCompassX();
            __u16 GetCompassY();
            __u16 GetCompassZ();
            ...
            //! Method for obtaining the temperature sensor data
            __u16 GetTemp();
